...
public class AddEmployeeTest {
    ...
    void testAddEmployeeSuccessfully() throws Exception {
        ...
        Employee emp1 = new Employee( "Tharun","tharun2003@gmail.com","Hyderabad", 50000);
        Employee emp2 = new Employee( "Kaustubh","kaustubh2003@gmail.com","Hyderabad", 50000);

        assertDoesNotThrow(() -> dao.add(emp));
        assertDoesNotThrow(() -> dao.add(emp1));
        assertDoesNotThrow(() -> dao.add(emp2));
    ...
    void testDuplicateEmployeeIdThrowsException() throws Exception {
        ...
        Employee emp1 = new Employee( "Mounish","mounish2006@gmail.com","Hyderabad", 50000);
        Employee emp2 = new Employee( "Mounish","mounish2005@gmail.com","Hyderabad", 50000);
